...
class MetricsCalculator:
    ...
    def __init__(self, compute_psnr: bool = True, compute_ssim: bool = True,
                 compute_lpips: bool = False, compute_mesh_error: bool = True):
        """
    ...
    def calculate_mesh_error(self, mesh1: trimesh.Trimesh, mesh2: trimesh.Trimesh) -> Dict[str, float]:
        """
        ...
        distances = np.linalg.norm(vertices1[:n_samples] - vertices2[:n_samples], axis=1)
    ...
    def evaluate_sequence(self, rendered_paths: List[str], 
                         ground_truth_paths: List[str]) -> Dict[str, float]:
        """
        ...
        """
        assert len(rendered_paths) == len(ground_truth_paths), \
