...
class VideoPreprocessor:
    ...
    def __init__(self, fps: int = 30, max_frames: Optional[int] = None, frame_skip: int = 1):
        """
    ...
    def resize_frames(self, frame_paths: List[str], target_size: Tuple[int, int]) -> List[np.ndarray]:
        """
